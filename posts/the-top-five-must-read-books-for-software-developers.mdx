...
_Algorithms to Live By_ is not directly related to software development, but instead focuses on how we humans do the things we do. It talks about how we can apply computer algorithms to our everyday life. We live in a world where we are constanstly being bombared with information and have to make choices quickly. How do we organize the data we are constanstly being hit with? How do we decide which option is the best? These are only a few of the many topics this book covers.
