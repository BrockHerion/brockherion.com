...
abstract: Learn how to create a REST API that will keep you and other developers happy.
isPublished: true
isFeatured: true
publishedOn: 2021-10-04T00:00:00-0400
imageUrl: /posts/designing-building-rest-apis-for-other-humans.png
---
...
<BlogSectionHeading heading="What is a REST API?" />
...
<BlogSectionHeading heading="What's the best way to build one?" />
...
<BlogSectionHeading heading="1. Don't use action names in your URLs, use HTTP verbs instead" />
...
<BlogSectionHeading heading="2. Use plural endpoints for collections" />
...
<BlogSectionHeading heading="3. Accept and return JSON" />
...
<BlogSectionHeading heading="4. Use correct HTTP Status codes" />
...
<BlogSectionHeading heading="5. Allow for filtering, sorting, and paging" />
...
<BlogSectionHeading heading="6. Versioning your APIs" />
...
<BlogSectionHeading heading="Conclusion" />
