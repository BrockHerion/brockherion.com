...
subTitle: tRPC is a tool that lets you build scalable backends quickly, as well as provide type safety between your front and backends.
...
Enter tRPC, a tool for building APIs with end-to-end type-safety. tRPC lets you create robust and scalable backends for your Next, React, and Node apps very quickly.

Have I peaked your interest? Then I encourage you to read on! In this article, we are going to be taking a look at what tRPC is and how you can set up and use it with Next.js.
