...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen py-2 bg-gray-800">
      ...
      <div className="grid grid-cols-2 bg-green-600 text-gray-900">
        <div
        ...
        <div className="relative">
          ...
          ></div>
          <div
            className="2xl:pr-96 xl:pr-72 lg:pr-36 md:pr-16 pr-6 pl-14 pt-6 bg-green-600 height-full top-0 left-0 absolute flex flex-col items-end justify-center"
      ...
      <div
        className="bg-green-600 text-gray-800 pb-2 pt-6 2xl:ml-96 xl:ml-72 lg:ml-36 md:ml-16 ml-6 2xl:pr-96 xl:pr-72 lg:pr-36 md:pr-16 pr-6"
