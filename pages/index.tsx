...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen py-2 bg-gray-800">
      ...
      <div className="grid grid-cols-2 justify-items-stretch bg-green-400 text-gray-900">
        <div
        ...
        <div className="relative">
          ...
          ></div>
          <div
            className="2xl:pr-96 xl:pr-72 lg:pr-36 md:pr-16 pr-6 pl-14 pt-6 bg-green-400 height-full top-0 left-0 relative flex flex-col items-end justify-center"
